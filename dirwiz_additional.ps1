...
New-ManagementRole -Parent “Distribution Groups” -Name UnitySyncGALContactsGroups
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Test-DatabaseEvent -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Test-MailboxAssistant -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\New-DistributionGroup -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Set-Group -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\New-DynamicDistributionGroup -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Set-DynamicDistributionGroup -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-SenderPermission -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-MessageRecallResult -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-DistributionGroupMember -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Receive-ExoJob -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-Mailbox -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Stop-ExoJob -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-ExoJob -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Remove-ExoJob -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-Recipient -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-EligibleDistributionGroupForMigration -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-MailboxPreferredLocation -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Start-AuditAssistant -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Write-AdminAuditLog -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Update-DistributionGroupMember -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Set-UnifiedAuditSetting -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Set-OrganizationConfig -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Remove-DynamicDistributionGroup -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Remove-DistributionGroupMember -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Remove-DistributionGroup -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-User -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-UnifiedAuditSetting -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-OrganizationalUnit -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-MailUser -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-Group -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-DynamicDistributionGroup -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Get-AcceptedDomain -Confirm:$false
Remove-ManagementRoleEntry UnitySyncGALContactsGroups\Add-DistributionGroupMember -Confirm:$false